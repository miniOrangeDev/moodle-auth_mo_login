...
class auth_mo_login_utilities
{
     ...
     * @param auth_mo_login_saml_response_class $response Response
     * @return bool
     * @throws Exception
     */
    public static function process_response($currenturl, $certfingerprint, $signaturedata,
                                            auth_mo_login_saml_response_class $response
    ) {
    ...
    /**
     * Validate Issuer
     * @param auth_mo_login_saml_response_class $samlresponse Samlresponse
