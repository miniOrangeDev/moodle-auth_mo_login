 ...
 */
class auth_mo_login_saml_response_class {
    /**
     * @var null
    ...
    public function __construct(DOMElement $xml = null) {
        ...
        for ($node = $xml->firstChild; $node !== null; $node = $node->nextSibling) {
            ...
            if ($node->localName === 'Assertion' || $node->localName === 'EncryptedAssertion') {
                $this->assertions[] = new auth_mo_login_saml_assertion_class($node);
            }
     ...
     *
     * @return auth_mo_login_saml_assertion_class[]|SAML2_EncryptedAssertion[] Get Assertion
     */
     ...
     *
     * @param auth_mo_login_saml_assertion_class[]|SAML2_EncryptedAssertion[] The assertions.
     */
